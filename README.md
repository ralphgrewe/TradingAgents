...
export FRED_API_KEY=...            # FRED macro indicators (optional; free key: https://fred.stlouisfed.org/docs/api/api_key.html)
```

Polymarket prediction-market data needs no API key.
