...
# Note: upstream's `test_env_backend_url_precedence` (#978, cli.utils.resolve_backend_url)
# is intentionally NOT included here — it exercises CLI env-precedence wiring
# that is out of scope for issue #15 (llm_clients provider registry) and is
# left for the CLI/graph-wiring issue that reconciles cli/utils.py.
