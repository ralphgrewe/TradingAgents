...
Ported from upstream TradingAgents (47cbb32, "feat(market): verified
market-data snapshot to ground numeric claims") as part of issue #18:
grafting anti-hallucination grounding into this fork's market analyst.
"""
