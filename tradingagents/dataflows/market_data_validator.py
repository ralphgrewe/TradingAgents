...
doesn't support. This module computes a ground-truth snapshot (latest OHLCV
row on or before the analysis date, common indicators, recent closes) the
analyst is told to treat as the source of truth for any exact numeric claim.
Deterministic, no LLM involved.

Ported from upstream TradingAgents (47cbb32 / 4e7821d) as part of grafting
anti-hallucination grounding into this fork's structured-JSON market analyst
(see market_analyst.py and agent_utils.get_instrument_context_from_state).
"""
