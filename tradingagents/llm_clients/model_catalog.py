...
MODEL_OPTIONS: ProviderModeOptions = {
    ...
    # `ollama pull` beyond the suggested defaults. ministral-3:3b/8b are kept
    # (dropped from upstream's list) because they're this fork's shipped
    # quick_think_llm/deep_think_llm defaults (default_config.py) and must
    ...
    # model their account has access to. Mistral keeps its own curated list
    # above (see "mistral") since our fork already maintains one.
    "kimi": _CUSTOM_ONLY,
    "groq": _CUSTOM_ONLY,
    "nvidia": _CUSTOM_ONLY,
